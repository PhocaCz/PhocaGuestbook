...
class JFormFieldPhocaguestbookGuestbook extends FormField
{
	...
	protected function getInput() {
       ...
       //build the list of categories
        ...
        $data = HTMLHelper::_('category.options', 'com_phocaguestbook');


		$required	= ((string) $this->element['required'] == 'true') ? TRUE : FALSE;


		array_unshift($data, HTMLHelper::_('select.option', '', '- '.Text::_('COM_PHOCAGUESTBOOK_SELECT_GUESTBOOK').' -', 'value', 'text'));
