...
<div id="j-main-container" class="span10">
	<div class="adminform">
		...
		<a href="https://www.phoca.cz/documents/3-phoca-guestbook-component/436-trying-to-prevent-from-spam" style="text-decoration:underline;" target="_blank">Trying to prevent from spam</a>
				</div>
			</div>
		</div>
		...
		<div class="ph-cpanel-right">
			<div class="well">
				...
				<div style="float:right; margin: 0 10px"><a href="https://www.phoca.cz/" target="_blank"><?php echo JHTML::_('image', 'media/com_phocaguestbook/images/administrator/logo.png', 'Phoca.cz' ) ?></a></div>
				</div>
			</div>
		</div>
